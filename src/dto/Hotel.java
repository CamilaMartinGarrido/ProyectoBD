...
public class Hotel {
    ...
    public Hotel(int id, String name, String chain, String adress, String category, String province) {
        setId_hotel(id);
        setName_hotel(name);
        setChain_hotel(chain);
        setAddress_hotel(adress);
        setCategory_hotel(category);
    }
    public Hotel( String name, String chain, String adress, String category, String province) {
